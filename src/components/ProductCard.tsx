...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-gray-50 h-44 sm:h-52 flex items-center justify-center">
        <img
      ...
      <div className="p-3">
        <h3 className="text-sm font-semibold text-gray-800 leading-tight line-clamp-2 mb-3">
          {product.name}
        </h3>
